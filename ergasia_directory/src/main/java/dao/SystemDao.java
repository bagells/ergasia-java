...
public class SystemDao {
	...
	public String loginusernameCheck(String username,String role) {
		String answer = null;
		if (role.equals("student")) {
			try {
				...
				if (!rs.next()) {
					answer = "There is no student with the username: " + username + ", please enter a valid username!";
				} else {
					answer = username;
				}
			...
			try {
				...
				if (!rs.next()) {
					answer = "There is no secretary with the username: " + username + ", please enter a valid username!";
				} else {
					answer = username;
				}
			} catch (SQLException e) {
			...
			try {
				...
				if (!rs.next()) {
					answer = "There is no proffesor with the username: " + username + ", please enter a valid username!";
				} else {
					answer = username;
				}
			} catch (SQLException e) {
	 ...
	 */
	public String passwordCheck(String username, String plainTextPassword,String role) {
		String answer = null;
		if (role.equals("student")){
			try {
			...
			try {
				PreparedStatement preparedStatement = connection.prepareStatement("SELECT password FROM secratary WHERE username=?");
			...
			try {
				PreparedStatement preparedStatement = connection.prepareStatement("SELECT password FROM proffesor WHERE username=?");
	...
	public String signupusernameCheck(String username ,String role) {
		String answer = null;
		if (role.equals("student")) {
			try {
				PreparedStatement preparedStatement = connection.prepareStatement("SELECT * FROM student WHERE username=?");
				...
				if (!rs.next()) {
					...
					answer = "There is already a student with the username: " + username + ", please enter a different username.";
				}
			} catch (SQLException e) {
				e.printStackTrace();
			}
			...
			try {
				...
				if (!rs.next()) {
					...
					answer = "There is already a ssecretart with the username: " + username + ", please enter a different username.";
				}
			} catch (SQLException e) {
				e.printStackTrace();
			}
			...
			try {
				...
				if (!rs.next()) {
					...
					answer = "There is already a proffessor with the username: " + username + ", please enter a different username.";
				}
			} catch (SQLException e) {
				e.printStackTrace();
			}
	...
	public void signup(int id, String username, String name, String surename,
		...
		try {
			...
			//	preparedStatement.setString(6, username);
				...
				//να θυμομαστε οτι τα γραφουμε ανορθογραφα
				PreparedStatement preparedStatement = connection.prepareStatement(
						"INSERT INTO secratary (id,username, name, surename, password,department) VALUES (?,?,?,?,?,?)"
				);
				preparedStatement.setInt(1, id);
				preparedStatement.setString(2, username);
				preparedStatement.setString(3, name);
				...
				//να θυμομαστε οτι τα γραφουμε ανορθογραφα
				PreparedStatement preparedStatement = connection.prepareStatement(
						"INSERT INTO proffesor (id,username, name, surename, password,department) VALUES (?,?,?,?,?,?)"
				);
				preparedStatement.setInt(1, id);
				preparedStatement.setString(2, username);
				preparedStatement.setString(3, name);
