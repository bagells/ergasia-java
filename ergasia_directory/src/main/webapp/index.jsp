	...
	<div class="login-html" >
		...
		<div class="login-form">
			...
			<div class="sign-in-htm">
				...
				<div class="group">
					<input type="radio" id="secretary" name="role_sin" value="secretary">
					<label for="secretary" style="color:#aaa;font-size:12px;" >Secretary</label>
					<input type="radio" id="student" name="role_sin" value="student">
					<label for="student" style="color:#aaa;font-size:12px;">Student</label>
					<input type="radio" id="professor" name="role_sin" value="professor">
