...
<nav class="navbar navbar-default navbar-fixed-top">
	...
	<ul class="nav navbar-nav">
		...
		<li><a href="secretary?action=viewCourseList">View
				course list</a></li>
		<li><a href="secretary?action=viewProfPerCourse">View
			course list and professor per course</a></li>
		<li><a href="secretary?action=AssignCourse">
			Assign Professor to course</a></li>
