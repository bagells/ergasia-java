...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <%String name="student"; %><div style="text-align:right;color:#bfbfbf;size:12px;">Welcome, <%= session.getAttribute("username") %> </div>
        
        <div class="collapse navbar-collapse navbar-right" id="myNavbar">

	<ul class="nav navbar-nav">
		<li><a href="student?action=viewStudentDetails">View
				student's personal data</a></li>
		<li><a href="student?action=viewStudentGrades">Show
