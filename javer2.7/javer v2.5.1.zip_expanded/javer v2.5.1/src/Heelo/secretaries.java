...
public class secretaries extends Users{
	...
	public <students> ArrayList<students> student_to_be_graded_list_creator(){
	...
	public void add_grades_to_course(Courses mathima, ArrayList<grades> lista ) {
		grades_list lista_vathmon = new grades_list(lista);
		mathima.lista_vathmon_kai_periodon.add(lista_vathmon);
